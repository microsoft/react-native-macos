...
type Props = $ReadOnly<{|
  ...
  needsPanelToBecomeKeyView?: ?boolean,
...
function createPressabilityConfig(props: Props): PressabilityConfig {
  return {
    ...
    nextValidKeyView: props.nextValidKeyView,
    previousValidKeyView: props.nextValidKeyView,
    needsPanelToBecomeKeyView: props.needsPanelToBecomeKeyView,
    canBecomeKeyView: props.canBecomeKeyView,
