...
module Helpers
    class Constants
        ...
        def self.socket_rocket_config
            config = @@socket_rocket_config.dup
            config[:platforms] = { :ios => min_ios_version_supported, :osx => min_macos_version_supported, :visionos => min_visionos_version_supported } # [macOS]
            return config
        end
