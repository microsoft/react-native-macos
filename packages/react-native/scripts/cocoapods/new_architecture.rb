...
class NewArchitectureHelper
    ...
    def self.install_modules_dependencies(spec, new_arch_enabled, folly_version)
        ...
        if ENV['USE_FRAMEWORKS']
            ...
            header_search_paths << "\"${PODS_CONFIGURATION_BUILD_DIR}/ReactCommon-macOS/ReactCommon.framework/Headers\""
            header_search_paths << "\"${PODS_CONFIGURATION_BUILD_DIR}/ReactCommon-macOS/ReactCommon.framework/Headers/react/nativemodule/core\""
